...
class _notepadState extends State<notepad> {
  ...
  void GetNotes() async {
    var url = "https://mohammad52110017.000webhostapp.com/api/view.php";
          ...
          actions: [
            ...
            TextButton(
              onPressed: () async {
                ...
                var url = "https://mohammad52110017.000webhostapp.com/api/add.php";
  ...
  void delete() async {
    var url = "https://mohammad52110017.000webhostapp.com/api/delete.php";
    var response = await post(Uri.parse(url),
        headers: <String, String>{
          'Content-Type': 'application/json; charset=UTF-8',
        },
                        ...
                        actions: [
                          ...
                          TextButton(
                            onPressed: () async {
                              ...
                              var url =
                                  "https://mohammad52110017.000webhostapp.com/api/edit.php";
                              var response = await post(Uri.parse(url),
                                  headers: <String, String>{
                                    'Content-Type':
